...
SimpleCov.profiles.define 'default' do
  ...
  add_filter File.join(SimpleCov.root, 'spec')
  add_filter File.join(SimpleCov.root, 'lib')
  add_filter File.join(SimpleCov.root, 'config')
  add_filter File.join(SimpleCov.root, 'db')
end
